...
namespace Equinox.UI.Web
{
    public class SerilogMiddleware
    {
        ...
        public SerilogMiddleware(ILogger logger, RequestDelegate next)
        {
            ...
            this.Logger = logger.ForContext<SerilogMiddleware>();
        }
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                ...
                log.Write(level, SerilogStringTemplates.MiddlewareMessageTemplate, instanceId.ToString(), httpContext.Request.Method, GetPath(httpContext), statusCode, elapsedMs);
            }
